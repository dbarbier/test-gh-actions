## Copied from https://github.com/quinoacomputing/quinoa/blob/develop/cmake/FindHypre.cmake
## original license is standard MIT 3-clause
## https://github.com/quinoacomputing/quinoa/blob/develop/LICENSE
################################################################################
#
...
if(HYPRE_INCLUDE_DIRS)
  _HYPRE_GET_VERSION(HYPRE_VERSION ${HYPRE_INCLUDE_DIRS}/HYPRE_config.h)
else()
  set(HYPRE_VERSION 0.0.0)
endif()

if(NOT BUILD_SHARED_LIBS)
  find_library(HYPRE_LIBRARIES NAMES libHYPRE64.a libHYPRE.a HYPRE64 HYPRE HINTS ${HYPRE_ROOT}/lib)
else()
  find_library(HYPRE_LIBRARIES NAMES HYPRE64 HYPRE HINTS ${HYPRE_ROOT}/lib)
endif()
